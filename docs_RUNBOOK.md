...
- A 4-botos ablakos terv OOM (Out-of-Memory) hibákat produkált a 4 GB korlát miatt.
...
## 2. Cluster állapot (valós, 2026-08-25)

| Node | IP | RAM | Foglalas | Megjegyzés |
|------|-----|-----|----------|------------|
| pve-01 | 10.10.40.11 | 16.6 GB | 57% | — |
| **pve-02** | **10.10.40.12** | **8.2 GB** | **27%** | **🎯 CÉL** |
| pve-03 | 10.10.40.13 | 16.0 GB | 78% | 📍 JELENLEGI HELY |
...
### 3.1. Előkészítés — Rollback pont (opcionális)
...
### 3.4. CPU finomhangolás (opcionális)
...
- **Online migráció jellege:** LXC-nél snapshot+restore, nem folyamatos élő futás (mint a VM-nél).
...
## 5. Migráció utáni lépések (FOLYTATÁS)
...
- [ ] `pct migrate` nem adott hibát
- [ ] A CT IP-je nem változott (`10.10.40.210/24`)
- [ ] Hermes botok elérhetők (tmux vagy grid)
